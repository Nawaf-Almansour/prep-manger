...
| Method | Endpoint | Auth | Role | Returns |
|--------|----------|------|------|---------|
| GET | `/products` | Yes | All | `Product[]` |
| GET | `/products/:id` | Yes | All | `Product` |
| POST | `/products` | Yes | Sup/Mgr | `Product` |
| PUT | `/products/:id` | Yes | Sup/Mgr | `Product` |
| DELETE | `/products/:id` | Yes | Manager | `success` |
