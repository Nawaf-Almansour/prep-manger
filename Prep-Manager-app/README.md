# 🍽️ Prep Manager - Restaurant Food Preparation Management

A comprehensive web application for managing restaurant food preparation tasks, inventory, and team workflow with role-based access control.
...
- `/products` - Product list (view only for prep staff)
...
- `POST /api/v1/products` - Create new product (Supervisor/Manager)
